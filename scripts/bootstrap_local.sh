...
wait_for_url "http://localhost:8080/health" "MCP health"
wait_for_url "http://localhost:8081/health" "RAG health"
...
wait_for_url "http://localhost:8080/ready" "MCP readiness"
wait_for_url "http://localhost:8081/ready" "RAG readiness and Ollama warmup" 120

echo "State Policy RAG starter is ready."
echo "MCP: http://localhost:8080/ready"
echo "RAG: http://localhost:8081/ready"
